package developmentpermission.lib;
...
public class ApiControllerAdvice extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, @Nullable Object body, HttpHeaders headers,
		...
		ResponseEntityForm re = new ResponseEntityForm(status.value(), ex.getMessage());
	...
	public ResponseEntity<Object> handleAll(Exception ex,WebRequest request){
		ResponseEntityForm re = new ResponseEntityForm(HttpStatus.INTERNAL_SERVER_ERROR.value(), "予期せぬ例外が起こりました");
