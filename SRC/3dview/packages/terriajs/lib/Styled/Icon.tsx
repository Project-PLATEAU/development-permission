...
export const GLYPHS = {
  // ↓ 茅野市開発許可申請システム追加分
  apply: require("../../wwwroot/images/icons/customicons/apply.svg"),
  answerConfirm: require("../../wwwroot/images/icons/customicons/answerconfirmation.svg"),
  lotSearch: require("../../wwwroot/images/icons/customicons/lotsearch.svg"),
  applicationSearch: require("../../wwwroot/images/icons/customicons/applicationsearch.svg"),
  mapbutton: require("../../wwwroot/images/icons/customicons/mapbutton.svg"),
  send: require("../../wwwroot/images/icons/customicons/send.svg"),
  chat: require("../../wwwroot/images/icons/customicons/chat.svg"),
  checked: require("../../wwwroot/images/icons/customicons/check.svg"),
  fileUpload: require("../../wwwroot/images/icons/customicons/paperclip.svg"),
  up: require("../../wwwroot/images/icons/customicons/up.svg"),
  down: require("../../wwwroot/images/icons/customicons/down.svg"),
  movingUp: require("../../wwwroot/images/icons/customicons/movingUp.svg"),
  movingDown: require("../../wwwroot/images/icons/customicons/movingDown.svg"),
  arrowLeft: require("../../wwwroot/images/icons/customicons/arrow-left.svg"),
  // ↑ 茅野市開発許可申請システム追加分
  ...
  info: require("../../wwwroot/images/icons/customicons/info.svg")
};
